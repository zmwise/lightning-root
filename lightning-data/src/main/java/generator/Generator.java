...
public class Generator {
    ...
    public static void main(String[] args) {
        String[] models = {"lightning-data"};
        for (String model : models) {
            /**
             * tabName 更改此参数为生成代码的表名称
             */
            shell(model, "t_app_sms");
        }
    }
    ...
    private static void shell(String model,String tabName){
        ...
        pc.setParent("com.osc.oscashdao");
        pc.setEntity("entity"+tabPackage);
        pc.setMapper("dao"+getName(tabName,UNDER_LINE));
        pc.setXml("xml"+getName(tabName,UNDER_LINE));
        pc.setService("service"+getName(tabName,UNDER_LINE));
        pc.setServiceImpl("serviceImpl"+getName(tabName,UNDER_LINE));
        pc.setController("web"+getName(tabName,UNDER_LINE));
