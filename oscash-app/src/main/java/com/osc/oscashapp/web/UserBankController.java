...
import com.osc.oscashserviceuser.bank.UserBankService;
...
/**
 * @description: UserBankController
 * @author: lizhiming
 * @since: 2017/11/10
 */
@RestController
public class UserBankController {
	...
	@ApiOperation(value = "用户银行卡列表",notes = "查询所有银行卡信息")
	@ApiImplicitParam(name = "bankId",value = "银行卡ID",required = true,dataType = "String")
	@GetMapping("/bank")
